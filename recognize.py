...
model = load_model("D:\FACE RECOGNISITION\FACE RECOGNISITION\Final_model (1).h5")

URL = 'http://192.168.125.19:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['Aniket', 'Chinmaya', 'Kausik', 'Sailesh', 'Surya', 'Uttam']
    return labels[pred]
